...
- Navigate to the `@content/Bookkeepings` directory and create a file with a unique name prefixed with `.mdx`, then start writing the markdown content inside.
...
- Navigate to your local development server at `http://localhost:3000/Bookkeeping`, where you will see your blog listed and sorted based on date. You can navigate to any blog to read it.
